...
//        channel.exchangeDeclare("2", "fanout");
        ...
        System.out.println("ReceiveLogs02等待接收的消息..........");
        DeliverCallback deliverCallbackack = ((s, delivery) -> {
            String message = new String(delivery.getBody(), "UTF-8");
            System.out.println("ReceiveLogs02控制台打印的接收的消息： " + message);
        });
        CancelCallback cancelCallback = ((s) -> {
            System.out.println("ReceiveLogs02控制台打印的接收失败的消息： " + s.getBytes(StandardCharsets.UTF_8));
        });
        //消费者消费
